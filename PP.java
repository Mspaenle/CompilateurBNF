...
class PPVar extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        if (locals.contains(name)) // Variables locales
            return new UPPVar(name);
        else // Variables globales
            return new UPPGVar(name); //to do
    }//toUPP
...
class PPLt extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ne1 = e1.toUPP(locals);
        UPPExpr ne2 = e2.toUPP(locals);
        return new UPPLt(ne1,ne2);//To do
    }//toUPP
...
class PPLe extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ne1 = e1.toUPP(locals);
        UPPExpr ne2 = e2.toUPP(locals);
        return new UPPLe(ne1,ne2);//To do
    }//toUPP
...
class PPEq extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ne1 = e1.toUPP(locals);
        UPPExpr ne2 = e2.toUPP(locals);
        return new UPPEq(ne1,ne2); //To do
    }//toUPP
...
class PPNe extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ne1 = e1.toUPP(locals);
        UPPExpr ne2 = e2.toUPP(locals);
        return new UPPNe(ne1,ne2); //To do
    }//toUPP
...
class PPGe extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ne1 = e1.toUPP(locals);
        UPPExpr ne2 = e2.toUPP(locals);
        return new UPPGe(ne1,ne2); //To do
    }//toUPP
...
class PPGt extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ne1 = e1.toUPP(locals);
        UPPExpr ne2 = e2.toUPP(locals);
        return new UPPGt(ne1,ne2);//To do
    }//toUPP
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        ...
        UPPExpr offset = new UPPMul(new UPPCte(4),nindex);
        return new UPPStore(new UPPAdd(narr, offset),nval);//To do
    }//toUPP
...
class PPWhile extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        ...
        return new UPPWhile(ncond,ni);//To do
    }//toUPP
...
class PPProcCall extends PPInst {
    ...
    UPPInst toUPP (ArrayList<String> locals) {
        ...
        for (PPExpr e : args)
            nargs.add(e.toUPP(locals));
        return new UPPProcCall(callee,nargs);//To do
    }//toUPP
...
class PPProc extends PPDef {
    ...
    UPPDef toUPP () {
        ...
        ncode = code.toUPP(nall);
        return new UPPProc(name,nargs,nlocals,ncode);//To do
    }//toUPP
